...
<div style="padding-top:1%">
    <nav class="navbar navbar-right navbar-expand-sm navbar-dark bg-dark">
        ...
        <li class="nav-item"><button id="checkOut" onclick=
		"window.location.href='{{route('scorders.checkout')}}'" type="button" style="margin-right:5px;" class=
		"btn btn-primary navbar-btn center-block">Check Out</button></li>
